...
//    cout<<"zreo="<<zero<<endl;
    ...
    ///添加跳出处理    可视化处理
    if(n2==zero){cout<<"输入错误，除数不能为0！"<<endl;return No;}
...
//    a<<i;
//    cout<<"a<<i="<<a<<endl;
////    cout<<"a*b  Length="<<a.length()<<endl;
//    cin>>a>>i;
//    }
//
//    b=a-a;
//    a-=b;
//    cout<<"b-a="<<b<<"    b-a  Length="<<a<<endl;
//
//
//    a>>2;
//    b<<3;
...
//    cout<<"b<<3:    "<<b<<"     b  Length:"<<b.length()<<endl;
    ...
    BigNumber n1(128),n2("128"),n3,n4("111111111111"),n5("127");///12位
    cout<<"n1=";n1.print();
    cout<<"n2=";n2.print();
    cout<<"n3=";n3.print();
    cin>>n3;
